...
<head>
    ...
    <link href="{{ asset('public/assets/css/pages/login/classic/login-5.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/>
            ...
            <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url({{ asset('public/assets/media/bg/bg-2.jpg') }});">
                <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                    <div class="login-signin">
                        ...
                        <form class="form" id="kt_login_signin_form" method="POST" action="{{ url('login') }}">
                            @csrf
